...
export async function GET(req) {
  ...
  if (existing) {
    try {
      ...
      return NextResponse.json({ error: "hstudy 이벤트 조회 실패", detail: err.message }, { status: 500 });
    }
  }
  ...
  try {
    ...
    return NextResponse.json({ error: "hstudy 이벤트 목록을 가져오지 못했습니다.", detail: err.message }, { status: 500 });
  } finally {
